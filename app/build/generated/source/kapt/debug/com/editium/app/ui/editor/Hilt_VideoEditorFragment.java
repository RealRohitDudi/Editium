...
public abstract class Hilt_VideoEditorFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VideoEditorFragment() {
    super();
  }

  Hilt_VideoEditorFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VideoEditorFragment_GeneratedInjector) this.generatedComponent()).injectVideoEditorFragment(UnsafeCasts.<VideoEditorFragment>unsafeCast(this));
    }
  }
